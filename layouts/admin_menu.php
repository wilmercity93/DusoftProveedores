<ul>
  ...
  <li>
    <a href="#" class="submenu-toggle">
      ...
      <ul class="nav submenu">
        <li><a href="certificados.php">Certificado Iva </a></li>
        <li><a href="certificados.php">Certificado en la Fuente </a> </li>
        <li><a href="certificados.php">Certificado Ica</a></li>
      </ul>
  </li>
</ul>
